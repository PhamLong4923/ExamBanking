...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("server = exambanking.database.windows.net; database = exambanking;uid=exambanking;pwd=Abyss040903@");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Payment>(entity =>
            {
                entity.HasKey(e => e.Payid)
                    .HasName("PK__Payment__082D8EEBBEEF736D");
                ...
                entity.HasOne(d => d.Acc)
                    ...
                    .HasForeignKey(d => d.Accid)
                    .HasConstraintName("FK__Payment__accid__18EBB532");
            });
            ...
            modelBuilder.Entity<Ticket>(entity =>
            {
                ...
                entity.HasOne(d => d.Acc)
                    ...
                    .HasForeignKey(d => d.Accid)
                    .HasConstraintName("FK__Ticket__accid__29221CFB");

                entity.HasOne(d => d.Bank)
                    .WithMany(p => p.Tickets)
                    .HasForeignKey(d => d.Bankid)
                    .HasConstraintName("FK__Ticket__bankid__2A164134");
            });
