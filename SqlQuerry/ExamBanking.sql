/****** Object:  Database [ExamBanking]    Script Date: 2/29/2024 10:25:11 PM ******/
CREATE DATABASE [ExamBanking]  (EDITION = 'Free', SERVICE_OBJECTIVE = 'Free', MAXSIZE = 32 MB) WITH CATALOG_COLLATION = SQL_Latin1_General_CP1_CI_AS, LEDGER = OFF;
GO
...
GO
/****** Object:  Table [dbo].[Access]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[Account]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Answer]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Bank]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Mode]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Payment]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Question]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Repository]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Role]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Section]    Script Date: 2/29/2024 10:25:11 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
ALTER TABLE [dbo].[Access]  WITH CHECK ADD FOREIGN KEY([repoid])
REFERENCES [dbo].[Repository] ([repoid])
GO
...
GO
ALTER TABLE [dbo].[Repository]  WITH CHECK ADD FOREIGN KEY([bankid])
REFERENCES [dbo].[Bank] ([bankid])
GO
ALTER TABLE [dbo].[Repository]  WITH CHECK ADD FOREIGN KEY([secondeditor])
REFERENCES [dbo].[Account] ([accid])
GO
